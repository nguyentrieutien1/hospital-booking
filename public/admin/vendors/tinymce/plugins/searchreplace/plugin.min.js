...
!(function () {
    ...
    var e,
        ...
        V = function (t, n) {
            var e;
            ((e = t), v.from(e.dom.parentNode).map(W.fromDom)).each(function (
                e
            ) {
        ...
        H =
            ...
            (i = "text"),
            {
                get: function (e) {
                    if (!o(e))
                        throw new Error(
                            "Can only get " + i + " value of a " + i + " node"
                        );
                    return a(e).getOr("");
                },
        ...
        z = function (e, t) {
            return (
                e.isBlock(t) || F(e.schema.getShortEndedElements(), t.nodeName)
            );
        },
        G = function (e, t) {
        ...
        K = function (e, t) {
            return (
                !e.isBlock(t) && F(e.schema.getWhiteSpaceElements(), t.nodeName)
            );
        },
        J = function () {
                ...
                a,
                {
                    ...
                    cef: function (e) {
                        var t,
                            ...
                            r,
                            o = M(
                                U(W.fromDom(e), "*[contenteditable=true]"),
                                function (e) {
                                    var t = e.dom;
                                    return Z(i, t, t);
                                }
